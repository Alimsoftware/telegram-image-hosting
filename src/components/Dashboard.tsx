  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-[calc(100vh-4rem)]">
      <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Painel do administrador</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Conectado como {user.username}</p>
        </div>
        <button
          onClick={onLogout}
